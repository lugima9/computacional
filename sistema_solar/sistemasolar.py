...
# Recibe: array de masas, array de posiciones iniciales y array de velocidades iniciales
# Devuelve: array de masas, array de posiciones iniciales y array de velocidades iniciales (reescalado)
...
# Devuelve: array con periodos simulados de cada planeta, array bool de comprobación
